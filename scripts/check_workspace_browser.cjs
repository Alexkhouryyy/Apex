...
(async()=>{try{
  ...
  console.log('PASS: real workspace editing, independent named boards, two-window switching, stale-draft protection, copy, active-workspace restart and mobile switcher.');
